...
**Goal:** Build the search results screen (per `docs/superpowers/specs/development-phase/2026-08-11-search-results-screen-design.md`) and wire it to the reader — clicking a chapter match jumps to that chapter and highlights the matched word; clicking a book match opens the book normally.
...
- [ ] **Step 4: Update `docs/tasks/development-phase/SPRINT-06-TASKS.md` Day 4 checkboxes**

Mark items 13, 14, 15 as ✅ (done) in `docs/tasks/development-phase/SPRINT-06-TASKS.md`'s Day 4 section, matching the file's existing ✅/🟡/❌ convention.
