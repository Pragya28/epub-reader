...
function RadioGroupRow({ className, ...props }: RadioPrimitive.Root.Props) {
  return (
    <RadioPrimitive.Root
      ...
      className={cn(
        "flex cursor-pointer items-center justify-between px-4 py-4 text-left outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring focus-visible:ring-inset data-checked:bg-surface-high data-checked:ring-[1.5px] data-checked:ring-selected data-checked:ring-inset",
        className,
      )}
      {...props}
    />
